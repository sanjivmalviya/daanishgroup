...
class Buy_air_ticket_international extends CI_Controller {
	...
	public function __construct(){
        ...
        $this->thisModuleName = 'Buy Internation Air Ticket';

        $this->thisModuleBaseUrl = site_url('buy_air_ticket_international') . '/';
...

	{
		...
		$this->load->view('buy_air_ticket_international');
