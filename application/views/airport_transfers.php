                        ...
                        <div class="col-lg-7 col-md-6 col-sm-8">
                            <div class="form-submit-area search-car bg-white">
                                <ul class="menu-tag-form">
                                    ...
                                    <li class="choose"><a href="<?php echo site_url('/airport_transfers'); ?>" title="">AIRPORT TRANSFERS</a></li>
                                ...
                                <div class="form-content">
                                    ...
                                    <div class="inner-box-tab">
                                        <form action="<?php echo site_url('airport_transfers/insert');?>" method="post" accept-charset="utf-8">
                                                ...
                                                <div class="field-row flex">
                                                    <div class="two-column">
                                                        ...
                                                        <div class="input-form">
                                                            <input type="text" name="pickup_point" placeholder="Enter an airport name or code" required="">
                                                        </div>
                                                    </div>
                                                    <div class="two-column">
                                                        <label>Drop-off Point</label>
                                                        <div class="input-form">
                                                            <input type="text" name="dropoff_point" placeholder="Enter a hotel name, address or..." required="">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="field-row flex">
                                                    <div class="two-column">
                                                        ...
                                                        <div class="box-date">
                                                            <div class="input-form date form_date" data-date="" data-date-format="dd/mm/yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd" >
                                                                <input size="16" type="text" value="" placeholder="" readonly="" name="arrival_date" required="">
                                                        ...
                                                        <div class="box-time select-box input-form">
                                                            <div class="controls input-append date  form_time" data-date="" data-date-format="hh:ii p" data-link-field="dtp_input3" data-link-format="hh:ii">
                                                                <input size="16" type="text" value="" placeholder="" readonly name="arrival_time">
                                                                <span class="add-on"><i class="icon-remove"></i></span>
                                                                <span class="add-on"><i class="icon-th"></i></span>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="two-column">
                                                        ...
                                                        <div class="box-time select-box input-form">
                                                            <div class="controls input-append date  form_time" data-date="" data-date-format="hh:ii p" data-link-field="dtp_input3" data-link-format="hh:ii">
                                                                <input size="16" type="text" value="" placeholder="" readonly name="departure_time" required="">
                                                                <span class="add-on"><i class="icon-remove"></i></span>
                                                                <span class="add-on"><i class="icon-th"></i></span>
                                                            </div>
                                                        </div>
