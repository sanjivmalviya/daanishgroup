                        ...
                        <div class="col-lg-7 col-md-6 col-sm-8">
                            <div class="form-submit-area search-car bg-white">
                                <ul class="menu-tag-form">
                                    <li><a href="<?php echo site_url('/buy_car_ticket'); ?>" title="">CAR HIRE</a></li>
                                    ...
                                    <li class="choose"><a href="<?php echo site_url('/bus_trucks'); ?>" title="">BUS & TRUCKS</a></li>
                                </ul>
                                <div class="form-content">
                                   ...
                                   <div class="col-md-12" style="margin-top: 10px;">
                                    ...
                                    <div class="inner-box-tab">
                                        <form action="<?php echo site_url('bus_trucks/insert');?>" method="post" accept-charset="utf-8">
                                                ...
                                                <div class="field-row flex">
                                                    <div class="one-column">
                                                        <div class="checkbox ver-1">
                                                            <input type="checkbox" id="is_dropoff_at_same_location" name="is_dropoff_at_same_location">
                                                            <label for="is_dropoff_at_same_location">Drop-off at same location</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="field-row flex">
                                                    <div class="two-column">
                                                        ...
                                                        <div class="box-date">
                                                            <div class="input-form date form_date" data-date="" data-date-format="dd/mm/yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                                                                <input size="16" type="text" value="" placeholder="" readonly="" name="pickup_date" required="">
                                                        ...
                                                        <div class="box-time select-box input-form">
                                                            <div class="controls input-append date  form_time" data-date="" data-date-format="hh:ii p" data-link-field="dtp_input3" data-link-format="hh:ii">
                                                                <input size="16" type="text" value="" placeholder="" readonly name="pickup_time">
                                                                <span class="add-on"><i class="icon-remove"></i></span>
                                                                <span class="add-on"><i class="icon-th"></i></span>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="two-column">
                                                        ...
                                                        <div class="box-date">
                                                            <div class="input-form date form_date" data-date="" data-date-format="dd/mm/yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                                                                <input size="16" type="text" value="" placeholder="" readonly="" name="dropoff_date" required="">
                                                                <span class="add-on"><i class="icon-remove"></i></span>
                                                                <span class="add-on"><i class="icon-th"></i></span>
                                                            </div>
                                                        </div>
                                                        <div class="box-time select-box input-form">
                                                            <div class="controls input-append date  form_time" data-date="" data-date-format="hh:ii p" data-link-field="dtp_input3" data-link-format="hh:ii">
                                                                <input size="16" type="text" value="" placeholder="" readonly name="dropoff_time"> 
                                                                <span class="add-on"><i class="icon-remove"></i></span>
                                                                <span class="add-on"><i class="icon-th"></i></span>
                                                            </div>
                                                        </div>
