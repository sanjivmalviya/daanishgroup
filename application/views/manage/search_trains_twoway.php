...
<head>
    ...
    <title>Train Inquiry - Two Way</title>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <table id="train_twoway_inquiries" class="table table-striped table-condensed table-bordered">
                            ...
                            <tbody>
                                ...
                                <?php if(isset($train_twoway_inquiries)){ ?>



                                    <?php $i=1; foreach($train_twoway_inquiries as $rs){ ?>
    ...
    <script>
        ...
        $('#train_twoway_inquiries').DataTable();
