            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="page-title-box">
                            ...
                            <h4 class="page-title">Cruise Inquiries</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <table id="cruise_inquiries" class="table table-striped table-condensed table-bordered">
                            ...
                            <thead>
                                ...
                                <th>Cruise Past Passenger Number</th>
                            ...
                            <tbody>
                                ...
                                <?php if(isset($cruise_inquiries)){ ?>



                                    <?php $i=1; foreach($cruise_inquiries as $rs){ ?>
                                        ...
                                        <tr>    
                                            ...
                                            <td><?php echo $rs->cruise_past_passenger_number; ?></td>
