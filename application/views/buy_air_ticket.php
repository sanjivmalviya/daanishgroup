                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="top-page-heading">
                                ...
                                <h3>BUY AIR STICKET</h3>

                            </div>

                            <div class="breadcrumbs">

                                <span class=" icon-home"></span>Buy Air Sticket
                        ...
                        <div class="col-lg-7 col-md-6 col-sm-8">
                            ...
                            <div class="form-submit-area air-sticket bg-white">
                                ...
                                <ul class="menu-tag-form">
                                    ...
                                    <li class="choose"><a href="#" title="">DOMESTIC AIR TICKET</a></li>

                                    <li><a href="<?php echo base_url('buy_air_ticket_international'); ?>" title="">INTERNATIONAL AIR TICKET</a></li>
                                ...
                                <div class="form-content">
                                    ...
                                    <div class="inner-box-tab" style="margin-top: 0px;">
                                        ...
                                        <form action="<?php echo site_url('buy_air_ticket/insert');?>" method="post" accept-charset="utf-8">
                                                ...
                                                <div class="field-row flex">
                                                    ...
                                                    <div class="one-column">
                                                        ...
                                                        <div class="checkbox ver-1">
                                                            ...
                                                            <input type="radio" id="economy-class" name="cavity" checked="" value="1">
                                                        ...
                                                        <div class="checkbox ver-1">
                                                            ...
                                                            <input type="radio" id="business-class" name="cavity" value="2">
                                                        ...
                                                        <div class="checkbox ver-1">
                                                            ...
                                                            <input type="radio" id="first-class" name="cavity" value="3">
