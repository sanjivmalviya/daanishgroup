                        ...
                        <div class="col-lg-7 col-md-6 col-sm-8">
                            <div class="form-submit-area search-car bg-white">
                                <ul class="menu-tag-form">
                                    ...
                                    <li class="choose"><a href="<?php echo site_url('/camper_vans'); ?>" title="">CAMPER VANS</a></li>
                                ...
                                <div class="form-content">
                                    ...
                                    <div class="inner-box-tab">
                                        <form action="<?php echo site_url('camper_vans/insert');?>" method="post"  accept-charset="utf-8">
                                            <div class="input-info-search">
                                                    ...
                                                    <div class="two-column">
                                                        ...
                                                        <div class="input-form select-box">
                                                            <select name="pickup_location">
                                                                ...
                                                                <option value="Alidelai">Alidelai</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="two-column">
                                                        ...
                                                        <div class="input-form date form_date" data-date="" data-date-format="dd/mm/yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                                                            <input size="16" type="text" value="" placeholder="" readonly="" name="pickup_date">
                                                ...
                                                <div class="field-row flex">
                                                    ...
                                                    <div class="two-column">
                                                        ...
                                                        <div class="input-form date form_date" data-date="" data-date-format="dd/mm/yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                                                            <input size="16" type="text" value="" placeholder="" readonly="" name="dropoff_date">
                                                            <span class="add-on"><i class="icon-remove"></i></span>
                                                            <span class="add-on"><i class="icon-th"></i></span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="field-row flex">
                                                    ...
                                                    <div class="two-column">
                                                        ...
                                                        <div class="input-form">
                                                            <input type="number" name="driver_age" placeholder="...">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="field-row flex">
                                                    <div class="one-column">
                                                        ...
                                                        <div class="input-form select-box">
                                                            <select name="vehicle_type">
                                                                <option value="Sleeps 1" selected>Sleeps 1</option>
                                                                <option value="Sleeps 2">Sleeps 2</option>
                                                                <option value="Sleeps 3">Sleeps 3</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
