                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="breadcrumbs">
                                <span class=" icon-home"></span>Search Cruises
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-lg-7 col-md-6 col-sm-8">
                            <div class="form-submit-area bg-white">
                                <ul class="menu-tag-form">
                                    <li class="choose"><a href="<?php echo site_url('cruise'); ?>" title="">CRUISES SEARCH</a></li>
                                    <li><a href="<?php echo site_url('cruise_river'); ?>" title="">RIVER CRUISES SEARCH</a></li>
                                </ul>
                                <div class="form-content">
                                    ...
                                    <div class="inner-box-tab">
                                        <form action="<?php echo site_url('cruise/insert');?>" method="POST" accept-charset="utf-8">
                                                ...
                                                <div class="field-row flex">
                                                    <div class="two-column">
                                                        ...
                                                        <div class="input-form date form_date" data-date="" data-date-format="dd/mm/yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                                                            <input size="16" type="text" value="" placeholder="" readonly="" name="cruise_date" required="">
