                        ...
                        <div class="col-lg-7 col-md-6 col-sm-8">
                            <div class="form-submit-area search-car bg-white">
                                <ul class="menu-tag-form">
                                    <li><a href="<?php echo base_url('/search_trains_oneway') ?>" title="">ONE WAY</a></li>
                                    <li class="choose"><a href="<?php echo base_url('/search_trains_twoway') ?>" title="">ROUND-TRIP</a></li>
                                ...
                                <div class="form-content">
                                  ...
                                  <div class="col-md-12" style="margin-top: 10px;">
                                    ...
                                    <div class="inner-box-tab">
                                        <form action="<?php echo site_url('search_trains_twoway/insert');?>" method="post" accept-charset="utf-8">
                                            <div class="input-info-search">
                                                ...
                                                <div class="field-row flex">
                                                    <div class="two-column">
                                                        ...
                                                        <div class="box-date">
                                                            <div class="input-form date form_date" data-date="" data-date-format="dd/mm/yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                                                                <input size="16" type="text" value="" placeholder="" readonly="" name="departure_date" required="">
                                                    ...
                                                    <div class="two-column">
                                                        ...
                                                        <div class="box-date">
                                                            <div class="input-form date form_date" data-date="" data-date-format="dd/mm/yyyy" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                                                                <input size="16" type="text" value="" placeholder="" readonly="" name="return_date">
                                                                <span class="add-on"><i class="icon-remove"></i></span>
                                                                <span class="add-on"><i class="icon-th"></i></span>
                                                            </div>
                                                        </div>
                                                        <div class="box-time select-box input-form">
                                                            <div class="controls input-append date  form_time" data-date="" data-date-format="hh:ii p" data-link-field="dtp_input3" data-link-format="hh:ii">
                                                                <input size="16" type="text" value="" placeholder="" readonly name="return_time">
                                                                <span class="add-on"><i class="icon-remove"></i></span>
                                                                <span class="add-on"><i class="icon-th"></i></span>
                                                            </div>
                                                        </div>
